...
extern CsmHashConfig job_CsmHashConfig [];
extern CsmEncryptConfig job_CsmEncryptConfig[];
extern CsmDecryptConfig job_CsmDecryptConfig[];
						...
						uint32 *resultLengthPtr)
{
	...
	else
	{
        ...
        Crypto_PrimitiveInfoType local_Crypto_PrimitiveInfoType ={*resultLengthPtr,CRYPTO_HASH,{job_CsmHashConfig[CsmJobs[jobId].CsmJobId].CsmAlgorithmFamily,CRYPTO_ALGOFAM_NOT_SET,0,CRYPTO_ALGOMODE_NOT_SET}};
        ...
        Crypto_JobType* local_Crypto_JobType_Ptr =&local_Crypto_JobType;
							 ...
							 CryIf_ProcessJob(1,local_Crypto_JobType_Ptr);
						   ...
						   uint32 *resultLengthPtr)
{
	...
	else
	{
	    Crypto_JobInfoType local_Crypto_JobInfoType={CsmJobs[jobId].CsmJobId,CsmJobs[jobId].CsmJobPriority};
	            const Crypto_JobInfoType* local_Crypto_JobInfoType_Ptr =&local_Crypto_JobInfoType;
	            Crypto_JobPrimitiveInputOutputType local_Crypto_JobPrimitiveInputOutputType ={dataPtr, dataLength,NULL,0,NULL,0,resultPtr,resultLengthPtr,NULL,NULL,0,NULL,NULL,mode};
	            Crypto_PrimitiveInfoType local_Crypto_PrimitiveInfoType ={*resultLengthPtr,CRYPTO_ENCRYPT,{job_CsmEncryptConfig[CsmJobs[jobId].CsmJobId].CsmEncryptAlgorithmFamily,CRYPTO_ALGOFAM_NOT_SET,job_CsmEncryptConfig[CsmJobs[jobId].CsmJobId].CsmEncryptAlgorithmKeyLength,CRYPTO_ALGOMODE_NOT_SET}};
	            ...
	            Crypto_JobType* local_Crypto_JobType_Ptr =&local_Crypto_JobType;
	                                 ...
	                                 if((*resultLengthPtr)>=job_CsmEncryptConfig[CsmJobs[jobId].CsmJobId].CsmEncryptResultMaxLength){
	                                 CryIf_ProcessJob(1,local_Crypto_JobType_Ptr);
	                                 uint8 ** resultPtr_PPtr=(uint8 **)resultPtr;
	                                 *resultPtr_PPtr= local_Crypto_JobType_Ptr->jobPrimitiveInputOutput.outputPtr;
...
Std_ReturnType Csm_Decrypt(     uint32 jobId,
    ...
    Crypto_JobInfoType local_Crypto_JobInfoType={CsmJobs[jobId].CsmJobId,CsmJobs[jobId].CsmJobPriority};
                    const Crypto_JobInfoType* local_Crypto_JobInfoType_Ptr =&local_Crypto_JobInfoType;
                    Crypto_JobPrimitiveInputOutputType local_Crypto_JobPrimitiveInputOutputType ={dataPtr, dataLength,NULL,0,NULL,0,resultPtr,resultLengthPtr,NULL,NULL,0,NULL,NULL,mode};
                    Crypto_PrimitiveInfoType local_Crypto_PrimitiveInfoType ={*resultLengthPtr,CRYPTO_DECRYPT,{job_CsmDecryptConfig[CsmJobs[jobId].CsmJobId].CsmDecryptAlgorithmFamily,CRYPTO_ALGOFAM_NOT_SET,job_CsmDecryptConfig[CsmJobs[jobId].CsmJobId].CsmDecryptAlgorithmKeyLength,CRYPTO_ALGOMODE_NOT_SET}};
                    ...
                    Crypto_JobType* local_Crypto_JobType_Ptr =&local_Crypto_JobType;
                                         ...
                                         if((*resultLengthPtr)>=job_CsmDecryptConfig[CsmJobs[jobId].CsmJobId].CsmDecryptResultMaxLength){
                                         CryIf_ProcessJob(1,local_Crypto_JobType_Ptr);
                                         uint8 ** resultPtr_PPtr=(uint8 **)resultPtr;
                                         *resultPtr_PPtr= local_Crypto_JobType_Ptr->jobPrimitiveInputOutput.outputPtr;
